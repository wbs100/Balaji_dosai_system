...
<section class="inner-section shop-part my-5" style="margin-bottom: 60px">
    <div class="container">
        <div class="row">
            {{-- ======================= FILTER SIDEBAR ======================= --}}
            <div class="col-lg-3">
                ...
                <div class="shop-widget">
                    ...
                    <form method="GET" action="{{ route('shop.index') }}">
                        <input type="text" name="search" value="{{ request('search') }}" class="form-control mb-0"
                ...
                <div class="shop-widget">
                    ...
                    <form method="GET" action="{{ route('shop.index') }}">
                        <ul class="shop-widget-list">
                            ...
                            <li>
                                <div class="shop-widget-content">
                                    <input type="radio" name="brand" id="brand{{ $brand->id }}" value="{{ $brand->id }}"
