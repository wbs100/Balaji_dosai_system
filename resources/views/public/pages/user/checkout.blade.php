                    ...
                    <div class="row">
                                ...
                                <li>
                                    ...
                                    <div class="select-custom bg-gray">
                                        ...
                                        <select name="province" class="form-control-select bg-white" required>
                                            ...
                                            @foreach (['Central', 'Eastern', 'North Central', 'Northern', 'North
                                            Western', 'Sabaragamuwa', 'Southern', 'Uva', 'Western'] as $province)
                        ...
                        <div class="col-lg-5">
                            <div class="order-summary sticky-top" style="top: 20px;">
                                <h3 class="step-title">YOUR ORDER</h3>
                                <table class="table table-mini-cart">
                                    <thead>
                                        <tr>
                                            <th colspan="2">Products List</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @php $total = 0; @endphp
                                    ...
                                    <tfoot>
                                        ...
                                        <tr class="order-total">
                                            ...
                                            <td class="text-end"><b class="total-price"
                                                    style="color: var(--my-secondary);">Rs.
                                ...
                                <div class="payment-methods">
                                    ...
                                    <ul class="list-unstyled">
                                        <li>
                                            ...
                                            {{-- Since COD is removed, this field is now permanently visible and
                                            required --}}
