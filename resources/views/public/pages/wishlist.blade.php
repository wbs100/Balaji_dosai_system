...
@section('content')
    <section class="inner-section single-banner" style="background: url(/assets/images/newsletter.jpg) no-repeat center;">
        <div class="container">
            <h2>wishlist</h2>
            <ol class="breadcrumb">
                                        ...
                                        <td class="table-action">
                                            <div class="d-flex">
                                                <a class="view"
                                                    ...
                                                    title="Single Product View"><i class="fas fa-eye"></i></a>
