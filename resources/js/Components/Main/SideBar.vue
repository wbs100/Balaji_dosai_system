    ...
    <div class="deznav">
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                <li class="menu-title">YOUR MENUS</li>
                <li :class="{ 'mm-active': $page.url.startsWith('/admin/dashboard') }">
                    <Link :href="route('dashboard')" class="" aria-expanded="false">
                    <div class="menu-icon">
                ...
                <li :class="{ 'mm-active': $page.url.startsWith('/admin/products') }">
                    <Link :href="route('products.index')" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_123_999)">
                                <!-- Shelf structure -->
                                <path
                                    d="M4 3C3.44772 3 3 3.44772 3 4V20C3 20.5523 3.44772 21 4 21H20C20.5523 21 21 20.5523 21 20V4C21 3.44772 20.5523 3 20 3H4ZM5 5H11V10H5V5ZM13 5H19V10H13V5ZM5 12H11V17H5V12ZM13 12H19V17H13V12Z"
                                    fill="#90959F" />

                                <!-- Lower right box as highlight -->
                                <path opacity="0.3" d="M13 12H19V17H13V12Z" fill="white" />
                            </g>
                            <defs>
                                <clipPath id="clip0_123_999">
                ...
                <li :class="{ 'mm-active': $page.url.startsWith('/admin/orders') }">
                    <Link :href="route('orders.index')" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_123_777)">
                                <!-- Document / invoice shape -->
                                <path
                                    d="M6 2C4.89543 2 4 2.89543 4 4V20C4 20.5523 4.44772 21 5 21H19C19.5523 21 20 20.5523 20 20V8.82843C20 8.29799 19.7893 7.78929 19.4142 7.41421L14.5858 2.58579C14.2107 2.21071 13.702 2 13.1716 2H6Z"
                                    fill="#90959F" />

                                <!-- Inner content highlight (like order lines) -->
                                <path opacity="0.3" d="M8 10H16V11.5H8V10ZM8 13H14V14.5H8V13ZM8 16H12V17.5H8V16Z"
                                    fill="white" />
                            </g>
                            <defs>
                                <clipPath id="clip0_123_777">
                                    <rect width="24" height="24" fill="white" />
                                </clipPath>
                            </defs>
                        </svg>
                ...
                <li :class="{ 'mm-active': $page.url.startsWith('/admin/public_users') }">
                    <Link :href="route('public-users.index')" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_123_449)">
                                ...
                                <path
                                    ...
                                    fill="#90959F" />
                                <path d="M2 20C2 16.6863 5.58172 14 9 14H11C7.58172 14 4 16.6863 4 20V20H2Z"
                                    fill="#90959F" />
                                ...
                                <path
                                    ...
                                    fill="#90959F" />
                                <path d="M14 20C14 16.6863 17.5817 14 21 14V20H14Z" fill="#90959F" />

                                <!-- Center user -->
                                <path
                                    d="M11 13C13.2091 13 15 11.2091 15 9C15 6.79086 13.2091 5 11 5C8.79086 5 7 6.79086 7 9C7 11.2091 8.79086 13 11 13Z"
                                    fill="#90959F" />
                                <path d="M6 20C6 17.2386 8.23858 15 11 15C13.7614 15 16 17.2386 16 20H6Z"
                                    fill="#90959F" />

                                <!-- Highlight center user body -->
                                <path opacity="0.3"
                                    d="M11 13C13.2091 13 15 11.2091 15 9C15 8.65264 14.9221 8.32276 14.7812 8.02782C14.0951 9.07011 12.7061 9.68115 11 9.26316C11 10.0771 11.3431 13 11 13Z"
                                    fill="white" />
                            </g>
                            <defs>
                        ...
                        <div class="menu-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <g clip-path="url(#clip0_123_551)">
                                    <!-- Document shape -->
                                    <path
                                        d="M5 2C4.44772 2 4 2.44772 4 3V21C4 21.5523 4.44772 22 5 22H19C19.5523 22 20 21.5523 20 21V7L14 2H5Z"
                                        fill="#90959F" />

                                    <!-- Line chart -->
                                    <polyline points="7 16 10 13 13 15 16 10" stroke="white" stroke-width="2"
                                        stroke-opacity="0.3" fill="none" />
                                    <circle cx="7" cy="16" r="1" fill="white" opacity="0.3" />
                                    <circle cx="10" cy="13" r="1" fill="white" opacity="0.3" />
                ...
                <li :class="{ 'mm-active': $page.url.startsWith('/admin/users') }">
                    <Link :href="route('users.index')" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_123_888)">
                                <!-- User head -->
                                <path
                                ...
                                <!-- Body circle -->
                                <path d="M4 20C4 16.6863 7.58172 14 12 14C16.4183 14 20 16.6863 20 20H4Z"
                                    fill="#90959F" />

                                <!-- Highlight inner body -->
                                <path opacity="0.3"
                                    d="M12 12C14.2091 12 16 10.2091 16 8C16 7.69972 15.9571 7.40866 15.8761 7.13291C15.1293 8.18184 13.6609 9 12 9C10.3391 9 8.87069 8.18184 8.12393 7.13291C8.04294 7.40866 8 7.69972 8 8C8 10.2091 9.79086 12 12 12Z"
                                    fill="white" />
                            </g>
                            <defs>
                                <clipPath id="clip0_123_888">
                                    <rect width="24" height="24" fill="white" />
                                </clipPath>
                            </defs>
                        </svg>
                ...
                <li :class="{ 'mm-active': $page.url.startsWith('/admin/settings') }">
                    <Link :href="route('settings.index')" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M12 15.5C13.933 15.5 15.5 13.933 15.5 12C15.5 10.067 13.933 8.5 12 8.5C10.067 8.5 8.5 10.067 8.5 12C8.5 13.933 10.067 15.5 12 15.5ZM12 17C9.23858 17 7 14.7614 7 12C7 9.23858 9.23858 7 12 7C14.7614 7 17 9.23858 17 12C17 14.7614 14.7614 17 12 17Z"
                                fill="#90959F" />
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M19.43 12.98C19.47 12.66 19.5 12.33 19.5 12C19.5 11.67 19.47 11.34 19.43 11.02L21.54 9.37C21.72 9.23 21.78 8.98 21.68 8.76L19.94 5.24C19.84 5.02 19.6 4.91 19.37 4.96L16.85 5.54C16.26 5.11 15.62 4.75 14.93 4.5L14.5 2H9.5L9.07 4.5C8.38 4.75 7.74 5.11 7.15 5.54L4.63 4.96C4.4 4.91 4.16 5.02 4.06 5.24L2.32 8.76C2.22 8.98 2.28 9.23 2.46 9.37L4.57 11.02C4.53 11.34 4.5 11.67 4.5 12C4.5 12.33 4.53 12.66 4.57 12.98L2.46 14.63C2.28 14.77 2.22 15.02 2.32 15.24L4.06 18.76C4.16 18.98 4.4 19.09 4.63 19.04L7.15 18.46C7.74 18.89 8.38 19.25 9.07 19.5L9.5 22H14.5L14.93 19.5C15.62 19.25 16.26 18.89 16.85 18.46L19.37 19.04C19.6 19.09 19.84 18.98 19.94 18.76L21.68 15.24C21.78 15.02 21.72 14.77 21.54 14.63L19.43 12.98ZM12 16.5C14.4853 16.5 16.5 14.4853 16.5 12C16.5 9.51472 14.4853 7.5 12 7.5C9.51472 7.5 7.5 9.51472 7.5 12C7.5 14.4853 9.51472 16.5 12 16.5Z"
                                fill="#90959F" />
                        </svg>
                ...
                <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Users
                                Manager</a>
                            <ul aria-expanded="false">
                ...
                <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <span class="nav-text">Profile</span><span class="badge badge-xs style-1 new-badge">New</span>
                    </a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <span class="nav-text">Account</span><span class="badge badge-xs style-1 new-badge">New</span>
                    </a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <span class="nav-text">AIKit</span><span class="badge badge-xs style-1 new-badge">New</span>
                    </a>
                    <ul aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li class="extra-menu-li">
                            <ul id="collapseExample" class="pt-0 extra-menu-links extra-menu-area">
                                ...
                                <li><a href="ui-placeholder.html">Placeholder</a></li>
                                <li><a href="ui-object-fit.html">Object Fit</a></li>
            ...
            <!-- <div class="copyright">
                <p>Yash Admin Sales Management System © <span class="current-year">2024</span> All Rights
                    Reserved
                </p>
